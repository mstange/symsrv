...
#[tokio::test]
async fn test_simple_server_two_requests() {
    let default_downstream = TestCacheDir::prepare(&[]).unwrap();
    ...
    let res1_future = symbol_cache.get_file("ShowSSEConfig.exe", "63E6C7F78000");
    let res2_future = symbol_cache.get_file("ShowSSEConfig.exe", "63E6C7F78000");
